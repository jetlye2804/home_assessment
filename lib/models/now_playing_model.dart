class NowPlayingModel {
  ...
  NowPlayingModel.fromJSON(Map<String, dynamic> json) {
    if (json['dates'] != null) {
      dates = NowPlayingDateData.fromJson(json['dates']);
    }
    page = json['page'];
...
class NowPlayingDateData {
  String? maximum;
  String? minimum;

  // Constructor
  NowPlayingDateData({this.maximum, this.minimum});

  // Convert JSON into model data
  NowPlayingDateData.fromJson(Map<String, dynamic> json) {
